...
def build_estimator(model_dir):
  ...
  if FLAGS.model_type == "wide":
    optimizer = tf.train.FtrlOptimizer(learning_rate=0.1,l1_regularization_strength=0,l2_regularization_strength=20)
    m = tf.contrib.learn.LinearClassifier(model_dir=model_dir,
                                          feature_columns=wide_columns,optimizer=optimizer)
